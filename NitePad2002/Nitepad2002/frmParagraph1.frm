...
Private Sub cmdOK_Click()
    If opnAlign(0).Value = True Then
         frmMDI.ActiveForm.rtfText.SelAlignment = rtfLeft
    ElseIf opnAlign(1).Value = True Then
         frmMDI.ActiveForm.rtfText.SelAlignment = rtfCenter
    Else
        opnAlign(2).Value = True
         frmMDI.ActiveForm.rtfText.SelAlignment = rtfRight
    End If
    Unload Me
End Sub
