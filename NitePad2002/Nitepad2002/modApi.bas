...
Public Function ReadINI(Section As String, Key As String, Optional sDefault As String)
    ...
    ReadINI = Left(sRet, GetPrivateProfileString(Section, Key, sDefault, sRet, Len(sRet), App.Path & "\Nitepad2002.ini"))
End Function
...
Public Sub WriteINI(Section As String, Key As String, Value As String)
    ...
    ' Write to INI file
    WritePrivateProfileString Section, Key, Value, App.Path & "\Nitepad2002.ini"
End Sub
